  ...
  grunt.initConfig({
    ...
    nexusDeployer: {
      release: {
        options: {
          ...
          url: 'http://javrepo01.nanocosm.com:8081/nexus/content/repositories/releases',
          artifact: 'liumeiplayer-<%= pkg.version %>-1.x86_64.rpm'
        }
      }
    },
    ...
    easy_rpm: {
        ...
        release: {
          ...
          files: [
            {src: 'app/**/*', dest: '/live/webplayer'},
            {src: 'bower_components/**/*', dest: '/live/webplayer/app/'},
            {src: 'dist/**/*', dest: '/live/webplayer/app/'}
          ]
        }
    }
