        ...
        //if has trackid passed in, need a utility later to get the index!!!
          if(typeof data.trackUid !== 'undefined' && data.trackUid){
            ...
            for(var i=0;i<broadcastData.trackList.trackArray.length;i++){
              if(broadcastData.trackList.trackArray[i].id === data.trackUid){
...
*/
        ...
        else if(typeof data.stationName !== 'undefined' && typeof data.playlistId !== 'undefined' && (typeof data.trackUid === 'undefined' || !data.trackUid)){
        ...
        else if(typeof data.stationName !== 'undefined' && typeof data.playlistId !== 'undefined' && typeof data.trackUid !== 'undefined'){
          var path6 = broadcastData.sRestAPIHost + data.stationName + '/playlists/' + data.playlistId + '/tracks';
          broadcastData.wpPlayer.nTrackUsageId = data.trackUid;
